...
public class VaultTestCard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cardNumber.setFont(new java.awt.Font("Tahoma", 3, 14));
        ...
        cardExpiryDate.setFont(new java.awt.Font("Tahoma", 3, 14));
    ...
    private void cardNumberKeyTyped(java.awt.event.KeyEvent evt) {
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            /*PayGateFormProperties status = sv.getUtil().getStatus(res);
            if (sv.error(res)) {
                // Request is denied
    ...
    private void cardExpiryDateKeyTyped(java.awt.event.KeyEvent evt) {

        display();
    }

    private void cardExpiryDateActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void reset() {
        ...
        PayGateFormProperties m = Mockups.singleVaultCard();
