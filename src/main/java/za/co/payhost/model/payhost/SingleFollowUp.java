...
public class SingleFollowUp extends Parent {
     ...
     *
     * @param payHost za.co.payhost Primary Object
     */
     ...
     * Payout Request</a>
     */
    public String byPayRequestID(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        ...
        return getUtil().callWebService(getPayHost().getUrl(), "SingleFollowUpRequest", body);
    }
     ...
     * Payout Request</a>
     */
    public String byMerchantOrderID(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SingleFollowUpRequest>"
                + "	<ns1:QueryRequest>"
                + "		<ns1:Account>"
                + "			<ns1:PayGateId>" + object.getProperty("payGateID") + "</ns1:PayGateId>"
     ...
     * Payout Request</a>
     */
    public String byTransactionID(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SingleFollowUpRequest>"
                + "	<ns1:QueryRequest>"
                + "		<ns1:Account>"
                + "			<ns1:PayGateId>" + object.getProperty("payGateID") + "</ns1:PayGateId>"
     ...
     */
    public String query(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SingleFollowUpRequest>"
                + "	<ns1:QueryRequest>"
                + "		<ns1:Account>"
                + "			<ns1:PayGateId>" + object.getProperty("payGateID") + "</ns1:PayGateId>"
     ...
     */
    public String voidOp(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SingleFollowUpRequest>"
                + "	<ns1:VoidRequest>"
                + "		<ns1:Account>"
                + "			<ns1:PayGateId>" + object.getProperty("payGateID") + "</ns1:PayGateId>"
     ...
     */
    public String settlment(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SingleFollowUpRequest>"
     ...
     */
    public String refund(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SingleFollowUpRequest>"
                + "	<ns1:RefundRequest>"
                + "		<ns1:Account>"
                + "			<ns1:PayGateId>" + object.getProperty("payGateID") + "</ns1:PayGateId>"
