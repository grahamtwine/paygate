...
public class SinglePayment extends Parent {
     ...
     */
    public String cardPayment(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
     ...
     * @throws IOException IOException
     */
    public String webPayment(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SinglePaymentRequest>"
     ...
     * @throws IOException IOException
     */
    public String tokenPayment(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SinglePaymentRequest>"
