...
public class SingleVault extends Parent {
     ...
     */
    public String cardVault(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
     ...
     */
    public String deleteVault(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SingleVaultRequest>"
     ...
     */
    public String lookupVault(PayGateFormProperties object) throws IOException, ParserConfigurationException, SAXException {
        String body = "<ns1:SingleVaultRequest>"
